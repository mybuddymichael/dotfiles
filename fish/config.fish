...
abbr -a bxb bunx --bun
abbr -a oc opencode
abbr -a pcx env CODEX_HOME=$HOME/.codex-personal codex
abbr -a wcx env CODEX_HOME=$HOME/.codex-work codex
...
abbr -a wpi mise exec node@24 -- nono run --allow-cwd --profile pi --trust-proxy-ca -- env PI_CODING_AGENT_DIR="$HOME/.pi-work/agent" pi --models openai-codex/gpt-5.5:medium
abbr -a wpi-unsafe mise exec node@24 -- env PI_CODING_AGENT_DIR="$HOME/.pi-work/agent" pi --models openai-codex/gpt-5.5:medium
abbr -a ppi mise exec node@24 -- nono run --allow-cwd --profile pi --trust-proxy-ca -- pi --models openai-codex/gpt-5.5:medium
abbr -a ppi-unsafe mise exec node@24 -- pi --models openai-codex/gpt-5.5:medium
