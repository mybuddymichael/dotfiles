...
return { -- Autoformat
  ...
  opts = {
    ...
    formatters_by_ft = {
      ...
      css = function(bufnr) return get_js_formatters(bufnr) end,
      less = function(bufnr) return get_js_formatters(bufnr) end,
      scss = function(bufnr) return get_js_formatters(bufnr) end,
      html = function(bufnr) return get_js_formatters(bufnr) end,
      yaml = function(bufnr) return get_js_formatters(bufnr) end,
      markdown = function(bufnr) return get_js_formatters(bufnr) end,
      toml = { 'taplo' },
    },
  },
}
